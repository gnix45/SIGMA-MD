...
global.owner = process.env.OWNER_NUMBER  || '237692872730' ;  // ADD YOUR NUMBER WITHOUT +
...
global.sudo  =  process.env.SUDO || "2376o2872730" ;          // DON'T REMOVE
...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://telegra.ph/file/13444f4d9deb81ce77c50.jpg' ;
//=================================================================================
...
module.exports = {
  ...
  botname: process.env.BOT_NAME       || 'joy craft',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `joy cratf`, // ADD YOUR NAME
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || 'joycraft',      // ADD YOUR STICKER AUTHOR NAME
  ...
  packname:  process.env.PACK_NAME  || "joycraft" ,          // ADD YOUR STICKER PACKNAME
